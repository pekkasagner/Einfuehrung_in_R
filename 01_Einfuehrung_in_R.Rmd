...
subtitle: "Grundlagen,<br>Datenanalyse,<br>Datenvisualisierung"
output: 
...
## Grundlagen, Datenanalyse, Datenvisualisierung
...
+ [Modern Statisctics with R (Thulin, 2021)](http://www.modernstatisticswithr.com/)
...
Die Themen und Probleme mit denen sich Data Science beschäftigt sind schier endlos. <br>Für die meisten gibt es Lösungen in R.

Das &raquo;einzige Lesezeichen, das man braucht&laquo;:
+ [Big Book of R (Baruffa, laufend aktualisiert)](https://www.bigbookofr.com/index.html)
...
+ &raquo;Ein Bild sagt mehr als tausend Worte.&laquo; 
...
#Was ist <img src="images/Rlogo.svg" width="50px"/>?

---

#Was ist <img src="images/Rlogo.svg" width="50px"/>? I/II

+ R ist eine Programmiersprache und <i>kostenfreie</i> Software.
...
+ <img src="images/rstudio.svg" width="60px"/> ist das Cockpit <img src="images/Rlogo.svg" width="30px"/> ist der Motor.
...
+ RStudio ist grundsätzlich nicht zwingend erforderlich, macht das Arbeiten aber wesentlich einfacher.
...
---
#.font90[Für (fast) jedes Problem eine maßgeschneiderte Lösung]

.center[
<img src="images/stickers_full.jpg" width="650px">
]
.right[
.font50[
Quelle: [Mitchell O'Hara-Wild](https://twitter.com/mitchoharawild/status/1007297976711110659)
]
]
